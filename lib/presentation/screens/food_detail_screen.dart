...
class _FoodDetailScreenState extends State<FoodDetailScreen> {
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Values per ${food.portionG.toStringAsFixed(0)} g',
                              style: TextStyle(
                                fontSize: 12,
              ...
              Card(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Nutrition for ${_amount.toStringAsFixed(0)} g',
                        style: const TextStyle(
                            fontWeight: FontWeight.w700, fontSize: 14),
                      ),
                      ...
                      _MacroRow(
                        ...
                        label: 'Calories',
                        value: '${food.scaledCalories(_amount).toStringAsFixed(0)} kcal',
                      ...
                      _MacroRow(
                        ...
                        label: 'Protein',
                        value: '${food.scaledProtein(_amount).toStringAsFixed(1)} g',
                      ...
                      _MacroRow(
                        ...
                        label: 'Carbohydrates',
                        value: '${food.scaledCarbs(_amount).toStringAsFixed(1)} g',
                      ...
                      _MacroRow(
                        ...
                        label: 'Fat',
                        value: '${food.scaledFat(_amount).toStringAsFixed(1)} g',
  ...
  Future<void> _addToLog(BuildContext context, FoodItem food) async {
    // Klavyeyi kapat (UX Iyilestirmesi)
